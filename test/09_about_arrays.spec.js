...
describe.skip("About Arrays (topics/09_about_arrays.js)", function() {
  it("array literal syntax and indexing", function() {
    let favouriteThings = ["cellar door", 42, true]; // note that array elements do not have to be of the same type
    assert.equal(
      __,
      favouriteThings[0],
